...
export default function Login() {
  ...
  const onSubmit = (e: FormEvent) => {
    e.preventDefault();
    console.log("Login clicked → waiting backend connection", { email, password });
  };
    ...
    <>
      ...
      <main className="km-login-wrap">
        ...
        >
          ...
          {/* ====== ฟอร์มล็อกอิน (ยังไม่เชื่อม backend) ====== */}
          <form className="km-form" onSubmit={onSubmit}>
            ...
            <button type="submit" className="km-btn km-btn--brand km-btn--full">
              เข้าสู่ระบบ
            </button>
          </form>
          ...
          >
            ...
            >
              ...
              <path d="M6.36 13.88c-.2-.6-.32-1.25-.32-1.88s.12-1.28.32-1.88V7.52H2.98A9.94 9.94 0 0 0 2 12c0 1.6.39 3.1 1.08 4.48ล3.28-2.6Z" fill="#FBBC05"/>
